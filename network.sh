...
function networkUp() {
  ...
  IMAGE_TAG=$IMAGETAG docker-compose ${COMPOSE_FILES} -f ${COMPOSE_FILE_RAFT2} up -d 2>&1
...
function networkDown() {
  ...
  docker-compose -f $COMPOSE_FILE_BASE -f $COMPOSE_FILE_COUCH -f $COMPOSE_FILE_CA -f ${COMPOSE_FILE_RAFT2} down --volumes --remove-orphans
...
COMPOSE_FILE_RAFT2=docker/docker-compose-etcdraft2.yaml
#
